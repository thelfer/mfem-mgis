...
namespace mfem_mgis {
  ...
  OrthotropicPlaneStressStandardSmallStrainMechanicsBehaviourIntegrator::
    ...
    for (size_type nj = 0; nj != nnodes; ++nj) {
      ...
      Ke(ni_0, nj_0) +=
          w * (Bi_0_0 * Bj_3_0 * Kip[3] + Bi_0_0 * Kip[0] * Bj_0_0 +
               Bj_3_0 * Kip[15] * Bi_3_0 + Kip[12] * Bj_0_0 * Bi_3_0);
      Ke(ni_0, nj_1) +=
          w * (Bi_0_0 * Kip[3] * Bj_3_1 + Kip[15] * Bj_3_1 * Bi_3_0 +
               Bj_1_1 * Kip[13] * Bi_3_0 + Bj_1_1 * Bi_0_0 * Kip[1]);
      Ke(ni_1, nj_0) +=
          w * (Bi_3_1 * Kip[12] * Bj_0_0 + Bi_3_1 * Bj_3_0 * Kip[15] +
               Bj_3_0 * Bi_1_1 * Kip[7] + Kip[4] * Bi_1_1 * Bj_0_0);
      Ke(ni_1, nj_1) +=
          w * (Bj_1_1 * Kip[5] * Bi_1_1 + Bi_1_1 * Bj_3_1 * Kip[7] +
               Bi_3_1 * Kip[15] * Bj_3_1 + Bj_1_1 * Bi_3_1 * Kip[13]);
