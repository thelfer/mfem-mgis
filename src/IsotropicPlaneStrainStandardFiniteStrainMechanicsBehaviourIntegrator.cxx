...
namespace mfem_mgis {
  ...
  IsotropicPlaneStrainStandardFiniteStrainMechanicsBehaviourIntegrator::
    ...
    for (size_type nj = 0; nj != nnodes; ++nj) {
      ...
      Ke(ni_0, nj_1) += w * (Kip[4] * dNi_0 * dNj_0 + dNj_1 * Kip[1] * dNi_0 +
                             Kip[16] * dNj_1 * dNi_1 + Kip[19] * dNi_1 * dNj_0);
      Ke(ni_1, nj_0) += w * (Kip[5] * dNi_1 * dNj_0 + dNi_0 * Kip[20] * dNj_0 +
                             dNj_1 * Kip[23] * dNi_0 + dNj_1 * Kip[8] * dNi_1);
      Ke(ni_1, nj_1) += w * (dNj_1 * dNi_1 * Kip[6] + dNj_1 * dNi_0 * Kip[21] +
