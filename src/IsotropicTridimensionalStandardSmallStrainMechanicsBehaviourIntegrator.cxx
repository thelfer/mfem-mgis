...
namespace mfem_mgis {
  ...
  IsotropicTridimensionalStandardSmallStrainMechanicsBehaviourIntegrator::
    ...
    Fe[ni_0] += w * (s[4] * Bi_4_0 + s[0] * Bi_0_0 + s[3] * Bi_3_0);
    Fe[ni_1] += w * (Bi_5_1 * s[5] + s[1] * Bi_1_1 + s[3] * Bi_3_1);
    Fe[ni_2] += w * (s[5] * Bi_5_2 + Bi_4_2 * s[4] + s[2] * Bi_2_2);
  ...
  IsotropicTridimensionalStandardSmallStrainMechanicsBehaviourIntegrator::
    ...
    for (size_type nj = 0; nj != nnodes; ++nj) {
      ...
      Ke(ni_0, nj_0) +=
          w * (Kip[21] * Bi_3_0 * Bj_3_0 + Bj_0_0 * Kip[24] * Bi_4_0 +
               Bj_4_0 * Bi_0_0 * Kip[4] + Bj_0_0 * Kip[0] * Bi_0_0 +
               Kip[3] * Bi_0_0 * Bj_3_0 + Bi_4_0 * Kip[28] * Bj_4_0 +
               Bj_0_0 * Kip[18] * Bi_3_0 + Kip[22] * Bj_4_0 * Bi_3_0 +
               Kip[27] * Bi_4_0 * Bj_3_0);
      Ke(ni_0, nj_1) +=
          w * (Kip[27] * Bi_4_0 * Bj_3_1 + Kip[21] * Bj_3_1 * Bi_3_0 +
               Bj_5_1 * Bi_4_0 * Kip[29] + Kip[1] * Bj_1_1 * Bi_0_0 +
               Bj_3_1 * Kip[3] * Bi_0_0 + Bj_1_1 * Kip[19] * Bi_3_0 +
               Bj_1_1 * Bi_4_0 * Kip[25] + Kip[23] * Bj_5_1 * Bi_3_0 +
               Kip[5] * Bj_5_1 * Bi_0_0);
      Ke(ni_0, nj_2) +=
          w * (Kip[23] * Bj_5_2 * Bi_3_0 + Kip[20] * Bj_2_2 * Bi_3_0 +
               Kip[5] * Bj_5_2 * Bi_0_0 + Bj_4_2 * Bi_4_0 * Kip[28] +
               Kip[2] * Bj_2_2 * Bi_0_0 + Bi_4_0 * Bj_2_2 * Kip[26] +
               Bj_4_2 * Kip[22] * Bi_3_0 + Bj_4_2 * Bi_0_0 * Kip[4] +
               Bi_4_0 * Bj_5_2 * Kip[29]);
      Ke(ni_1, nj_0) +=
          w * (Bi_1_1 * Kip[9] * Bj_3_0 + Bi_5_1 * Kip[33] * Bj_3_0 +
               Bi_5_1 * Kip[34] * Bj_4_0 + Bj_0_0 * Bi_1_1 * Kip[6] +
               Bj_0_0 * Bi_5_1 * Kip[30] + Kip[10] * Bi_1_1 * Bj_4_0 +
               Bj_0_0 * Bi_3_1 * Kip[18] + Bi_3_1 * Kip[22] * Bj_4_0 +
               Bi_3_1 * Kip[21] * Bj_3_0);
      Ke(ni_1, nj_1) +=
          w * (Bi_3_1 * Kip[21] * Bj_3_1 + Bi_3_1 * Bj_1_1 * Kip[19] +
               Bi_5_1 * Bj_1_1 * Kip[31] + Bi_1_1 * Bj_3_1 * Kip[9] +
               Bi_5_1 * Bj_5_1 * Kip[35] + Bi_1_1 * Bj_1_1 * Kip[7] +
               Bi_1_1 * Kip[11] * Bj_5_1 + Bi_5_1 * Kip[33] * Bj_3_1 +
               Kip[23] * Bi_3_1 * Bj_5_1);
      Ke(ni_1, nj_2) +=
          w * (Bi_5_1 * Bj_2_2 * Kip[32] + Kip[10] * Bj_4_2 * Bi_1_1 +
               Bj_4_2 * Bi_3_1 * Kip[22] + Bi_5_1 * Bj_4_2 * Kip[34] +
               Kip[23] * Bi_3_1 * Bj_5_2 + Bi_5_1 * Kip[35] * Bj_5_2 +
               Bi_1_1 * Kip[11] * Bj_5_2 + Bi_1_1 * Kip[8] * Bj_2_2 +
               Kip[20] * Bi_3_1 * Bj_2_2);
      Ke(ni_2, nj_0) +=
          w * (Kip[27] * Bi_4_2 * Bj_3_0 + Bi_2_2 * Bj_4_0 * Kip[16] +
               Bi_2_2 * Kip[15] * Bj_3_0 + Bj_0_0 * Kip[24] * Bi_4_2 +
               Bj_0_0 * Kip[30] * Bi_5_2 + Kip[33] * Bi_5_2 * Bj_3_0 +
               Bi_5_2 * Kip[34] * Bj_4_0 + Kip[28] * Bi_4_2 * Bj_4_0 +
               Bj_0_0 * Bi_2_2 * Kip[12]);
      Ke(ni_2, nj_1) +=
          w * (Bj_1_1 * Kip[25] * Bi_4_2 + Kip[27] * Bj_3_1 * Bi_4_2 +
               Kip[33] * Bi_5_2 * Bj_3_1 + Bi_5_2 * Bj_5_1 * Kip[35] +
               Bj_5_1 * Bi_4_2 * Kip[29] + Bj_1_1 * Bi_5_2 * Kip[31] +
               Kip[17] * Bj_5_1 * Bi_2_2 + Bj_3_1 * Bi_2_2 * Kip[15] +
               Bj_1_1 * Bi_2_2 * Kip[13]);
      Ke(ni_2, nj_2) +=
          w * (Bj_4_2 * Bi_2_2 * Kip[16] + Bj_5_2 * Bi_4_2 * Kip[29] +
               Bj_4_2 * Kip[28] * Bi_4_2 + Bj_2_2 * Bi_4_2 * Kip[26] +
               Bi_5_2 * Kip[35] * Bj_5_2 + Kip[14] * Bi_2_2 * Bj_2_2 +
               Bj_4_2 * Bi_5_2 * Kip[34] + Kip[17] * Bi_2_2 * Bj_5_2 +
               Bi_5_2 * Bj_2_2 * Kip[32]);
