...
namespace mfem_mgis {
  ...
  FBarIsotropicPlaneStrainBehaviourIntegrator::selectIntegrationRule(
  ...
  FBarIsotropicPlaneStrainBehaviourIntegrator::buildQuadratureSpace(
  ...
  real FBarIsotropicPlaneStrainBehaviourIntegrator::getIntegrationPointWeight(
      mfem::ElementTransformation &tr,
      const mfem::IntegrationPoint &ip) const noexcept {
    return ip.weight * tr.Weight();
  }
  const mfem::IntegrationRule &
  FBarIsotropicPlaneStrainBehaviourIntegrator::getIntegrationRule(
      const mfem::FiniteElement &e,
      const mfem::ElementTransformation &t) const {
    return FBarIsotropicPlaneStrainBehaviourIntegrator::selectIntegrationRule(
        e, t);
  }

  FBarIsotropicPlaneStrainBehaviourIntegrator::RotationMatrix
  FBarIsotropicPlaneStrainBehaviourIntegrator::getRotationMatrix(
      const size_type) const {
    return RotationMatrix{};
  }  // end of getRotationMatrix

  bool FBarIsotropicPlaneStrainBehaviourIntegrator::
      requiresCurrentSolutionForJacobianAssembly() const noexcept {
    return true;
  }  // end of requiresCurrentSolutionForJacobianAssembly

  void FBarIsotropicPlaneStrainBehaviourIntegrator::rotateGradients(
      std::span<real>, const RotationMatrix &) {}  // end of rotateGradients

  std::span<const real>
  FBarIsotropicPlaneStrainBehaviourIntegrator::rotateThermodynamicForces(
      std::span<const real> s, const RotationMatrix &) {
    return s;
  }

  void FBarIsotropicPlaneStrainBehaviourIntegrator::rotateTangentOperatorBlocks(
      std::span<real>, const RotationMatrix &) {}

  bool FBarIsotropicPlaneStrainBehaviourIntegrator::integrate(
      const mfem::FiniteElement &e,
      mfem::ElementTransformation &tr,
      const mfem::Vector &u,
  ...
  void FBarIsotropicPlaneStrainBehaviourIntegrator::updateResidual(
      mfem::Vector &Fe,
      const mfem::FiniteElement &e,
      mfem::ElementTransformation &tr,
      const mfem::Vector &u) {
  ...
  void FBarIsotropicPlaneStrainBehaviourIntegrator::updateJacobian(
      mfem::DenseMatrix &Ke,
      const mfem::FiniteElement &e,
      mfem::ElementTransformation &tr,
      const mfem::Vector &u) {
  ...
  void FBarIsotropicPlaneStrainBehaviourIntegrator::computeInnerForces(
      mfem::Vector &Fe,
      const mfem::FiniteElement &e,
      mfem::ElementTransformation &tr) {
  ...
  FBarIsotropicPlaneStrainBehaviourIntegrator::
      ~FBarIsotropicPlaneStrainBehaviourIntegrator() = default;
