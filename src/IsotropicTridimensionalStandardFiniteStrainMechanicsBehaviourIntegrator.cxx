...
namespace mfem_mgis {
  ...
  IsotropicTridimensionalStandardFiniteStrainMechanicsBehaviourIntegrator::
    ...
    Fe[ni_0] += w * (s[3] * dNi_1 + s[5] * dNi_2 + s[0] * dNi_0);
    Fe[ni_1] += w * (dNi_0 * s[4] + s[7] * dNi_2 + s[1] * dNi_1);
  ...
  IsotropicTridimensionalStandardFiniteStrainMechanicsBehaviourIntegrator::
    ...
    for (size_type nj = 0; nj != nnodes; ++nj) {
      ...
      Ke(ni_0, nj_0) += w * (dNj_2 * Kip[5] * dNi_0 + dNi_1 * Kip[30] * dNj_1 +
                             dNj_2 * dNi_1 * Kip[32] + dNi_1 * Kip[27] * dNj_0 +
                             Kip[3] * dNj_1 * dNi_0 + Kip[48] * dNi_2 * dNj_1 +
                             Kip[45] * dNi_2 * dNj_0 + dNj_2 * dNi_2 * Kip[50] +
                             dNj_0 * Kip[0] * dNi_0);
      Ke(ni_0, nj_1) += w * (dNj_2 * Kip[52] * dNi_2 + Kip[4] * dNj_0 * dNi_0 +
                             dNj_2 * Kip[7] * dNi_0 + dNi_1 * Kip[28] * dNj_1 +
                             dNj_2 * dNi_1 * Kip[34] + Kip[46] * dNi_2 * dNj_1 +
                             Kip[49] * dNi_2 * dNj_0 + dNi_1 * dNj_0 * Kip[31] +
                             Kip[1] * dNj_1 * dNi_0);
      Ke(ni_0, nj_2) += w * (dNj_0 * dNi_0 * Kip[6] + dNi_2 * Kip[53] * dNj_1 +
                             dNj_2 * Kip[2] * dNi_0 + Kip[35] * dNi_1 * dNj_1 +
                             Kip[51] * dNi_2 * dNj_0 + Kip[29] * dNj_2 * dNi_1 +
                             dNj_2 * dNi_2 * Kip[47] + dNi_1 * Kip[33] * dNj_0 +
                             Kip[8] * dNj_1 * dNi_0);
      Ke(ni_1, nj_0) += w * (dNj_2 * dNi_0 * Kip[41] + dNi_2 * Kip[66] * dNj_1 +
                             Kip[39] * dNj_1 * dNi_0 + dNi_1 * Kip[12] * dNj_1 +
                             dNi_1 * dNj_0 * Kip[9] + dNj_2 * dNi_1 * Kip[14] +
                             dNj_2 * Kip[68] * dNi_2 + Kip[36] * dNj_0 * dNi_0 +
                             dNi_2 * dNj_0 * Kip[63]);
      Ke(ni_1, nj_1) += w * (Kip[13] * dNi_1 * dNj_0 + Kip[64] * dNi_2 * dNj_1 +
                             Kip[10] * dNi_1 * dNj_1 + dNj_0 * Kip[40] * dNi_0 +
                             Kip[37] * dNj_1 * dNi_0 + Kip[67] * dNi_2 * dNj_0 +
                             Kip[16] * dNj_2 * dNi_1 + Kip[70] * dNj_2 * dNi_2 +
                             dNj_2 * Kip[43] * dNi_0);
      Ke(ni_1, nj_2) += w * (Kip[38] * dNj_2 * dNi_0 + Kip[71] * dNi_2 * dNj_1 +
                             dNi_1 * Kip[17] * dNj_1 + dNj_2 * dNi_1 * Kip[11] +
                             dNi_1 * dNj_0 * Kip[15] + dNj_1 * Kip[44] * dNi_0 +
                             Kip[42] * dNj_0 * dNi_0 + dNj_2 * Kip[65] * dNi_2 +
                             dNi_2 * dNj_0 * Kip[69]);
      Ke(ni_2, nj_0) += w * (dNj_2 * dNi_1 * Kip[77] + dNj_0 * dNi_0 * Kip[54] +
                             dNi_2 * dNj_0 * Kip[18] + dNi_1 * dNj_0 * Kip[72] +
                             dNi_2 * Kip[21] * dNj_1 + dNj_1 * Kip[57] * dNi_0 +
                             dNi_1 * Kip[75] * dNj_1 + dNj_2 * Kip[59] * dNi_0 +
                             dNj_2 * Kip[23] * dNi_2);
      Ke(ni_2, nj_1) += w * (Kip[58] * dNj_0 * dNi_0 + dNj_2 * dNi_1 * Kip[79] +
                             Kip[61] * dNj_2 * dNi_0 + dNi_2 * dNj_0 * Kip[22] +
                             Kip[76] * dNi_1 * dNj_0 + dNi_2 * dNj_1 * Kip[19] +
                             Kip[73] * dNi_1 * dNj_1 + Kip[55] * dNj_1 * dNi_0 +
                             dNj_2 * dNi_2 * Kip[25]);
      Ke(ni_2, nj_2) += w * (Kip[62] * dNj_1 * dNi_0 + dNj_2 * Kip[20] * dNi_2 +
                             Kip[26] * dNi_2 * dNj_1 + dNj_2 * dNi_1 * Kip[74] +
                             dNi_1 * Kip[80] * dNj_1 + dNi_1 * dNj_0 * Kip[78] +
                             dNj_2 * Kip[56] * dNi_0 + Kip[24] * dNi_2 * dNj_0 +
                             dNj_0 * Kip[60] * dNi_0);
