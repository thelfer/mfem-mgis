...
namespace mfem_mgis {
  ...
  OrthotropicPlaneStressStandardFiniteStrainMechanicsBehaviourIntegrator::
    ...
    for (size_type nj = 0; nj != nnodes; ++nj) {
      ...
      Ke(ni_0, nj_0) += w * (Kip[3] * dNj_1 * dNi_0 + dNj_0 * Kip[0] * dNi_0 +
      ...
      Ke(ni_1, nj_0) += w * (dNj_0 * dNi_0 * Kip[20] + dNj_1 * Kip[23] * dNi_0 +
                             dNi_1 * dNj_1 * Kip[8] + dNi_1 * dNj_0 * Kip[5]);
      Ke(ni_1, nj_1) += w * (dNi_1 * Kip[9] * dNj_0 + dNj_0 * dNi_0 * Kip[24] +
