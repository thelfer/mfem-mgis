...
namespace mfem_mgis {
  ...
  OrthotropicPlaneStressStandardFiniteStrainMechanicsBehaviourIntegrator::
    ...
    for (size_type nj = 0; nj != nnodes; ++nj) {
      ...
      Ke(ni_0, nj_0) += w * (dNj_1 * dNi_0 * Kip[3] + dNj_1 * dNi_1 * Kip[18] +
                             dNi_1 * Kip[15] * dNj_0 + dNi_0 * dNj_0 * Kip[0]);
      Ke(ni_0, nj_1) += w * (Kip[16] * dNj_1 * dNi_1 + dNj_1 * Kip[1] * dNi_0 +
                             Kip[19] * dNi_1 * dNj_0 + Kip[4] * dNi_0 * dNj_0);
      Ke(ni_1, nj_0) += w * (dNj_1 * Kip[8] * dNi_1 + dNi_0 * Kip[20] * dNj_0 +
                             dNj_1 * Kip[23] * dNi_0 + Kip[5] * dNi_1 * dNj_0);
      Ke(ni_1, nj_1) += w * (dNi_1 * Kip[9] * dNj_0 + dNi_0 * Kip[24] * dNj_0 +
                             dNj_1 * dNi_0 * Kip[21] + dNj_1 * dNi_1 * Kip[6]);
