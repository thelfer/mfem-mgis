...
namespace mfem_mgis {
  ...
  IsotropicPlaneStressStandardFiniteStrainMechanicsBehaviourIntegrator::
    ...
    Fe[ni_0] += s[3] * w * dNi_1 + s[0] * dNi_0 * w;
    Fe[ni_1] += s[1] * w * dNi_1 + s[4] * dNi_0 * w;
  ...
  IsotropicPlaneStressStandardFiniteStrainMechanicsBehaviourIntegrator::
    ...
    for (size_type nj = 0; nj != nnodes; ++nj) {
      ...
      Ke(ni_0, nj_0) += Kip[15] * dNj_0 * w * dNi_1 +
                        Kip[18] * dNj_1 * w * dNi_1 +
                        Kip[3] * dNj_1 * dNi_0 * w + dNj_0 * Kip[0] * dNi_0 * w;
      Ke(ni_0, nj_1) += dNj_0 * Kip[19] * w * dNi_1 +
                        Kip[16] * dNj_1 * w * dNi_1 +
                        dNj_1 * Kip[1] * dNi_0 * w + dNj_0 * Kip[4] * dNi_0 * w;
      Ke(ni_1, nj_0) +=
          dNj_0 * dNi_0 * Kip[20] * w + dNj_0 * w * Kip[5] * dNi_1 +
          dNj_1 * Kip[23] * dNi_0 * w + dNj_1 * w * Kip[8] * dNi_1;
      Ke(ni_1, nj_1) +=
          Kip[6] * dNj_1 * w * dNi_1 + Kip[9] * dNj_0 * w * dNi_1 +
          dNj_1 * dNi_0 * w * Kip[21] + dNj_0 * dNi_0 * w * Kip[24];
