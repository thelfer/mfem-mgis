...
namespace mfem_mgis {
  ...
  IsotropicPlaneStressStandardFiniteStrainMechanicsBehaviourIntegrator::
    ...
    for (size_type nj = 0; nj != nnodes; ++nj) {
      ...
      Ke(ni_0, nj_0) += w * (dNj_1 * dNi_1 * Kip[18] + dNj_1 * dNi_0 * Kip[3] +
                             dNi_0 * dNj_0 * Kip[0] + dNi_1 * Kip[15] * dNj_0);
      Ke(ni_0, nj_1) += w * (dNi_1 * dNj_0 * Kip[19] + Kip[4] * dNi_0 * dNj_0 +
                             dNj_1 * dNi_1 * Kip[16] + dNj_1 * Kip[1] * dNi_0);
