...
extra flexibility allowed by `MFEM/MGIS`. For instance, `MFEM` elastic
kernels assume that material properties (Young's modulus, Poisson's
ratio) are uniform on each material.
