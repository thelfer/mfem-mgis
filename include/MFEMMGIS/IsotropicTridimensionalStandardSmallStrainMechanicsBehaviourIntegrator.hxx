...
namespace mfem_mgis {
  ...
  /*!
   */
  struct MFEM_MGIS_EXPORT IsotropicTridimensionalStandardSmallStrainMechanicsBehaviourIntegrator
 ...
 */
IsotropicTridimensionalStandardSmallStrainMechanicsBehaviourIntegrator(const FiniteElementDiscretization &,
             const size_type,
...
//! \brief destructor
~IsotropicTridimensionalStandardSmallStrainMechanicsBehaviourIntegrator() override;
...
void updateStiffnessMatrix(mfem::DenseMatrix &,
    ...
    };  // end of struct IsotropicTridimensionalStandardSmallStrainMechanicsBehaviourIntegrator
