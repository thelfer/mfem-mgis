...
#ifndef LIB_MFEM_MGIS_UTILITIES_OPTIONALREFERENCE_HXX
#define LIB_MFEM_MGIS_UTILITIES_OPTIONALREFERENCE_HXX
...
namespace std {
  ...
  template <typename ValueType>
  struct hash<::mfem_mgis::OptionalReference<ValueType>> {
    [[nodiscard]] size_t operator()(
        ::mfem_mgis::OptionalReference<ValueType> p) const noexcept {
...
namespace mgis::internal {
  ...
  template <typename ValueType>
  struct InvalidValueTraits<mfem_mgis::OptionalReference<ValueType>> {
    static constexpr bool isSpecialized = true;
    static mfem_mgis::OptionalReference<ValueType> getValue() noexcept {
      return {};
    }
  };
...
#endif /* LIB_MFEM_MGIS_UTILITIES_OPTIONALREFERENCE_HXX */
