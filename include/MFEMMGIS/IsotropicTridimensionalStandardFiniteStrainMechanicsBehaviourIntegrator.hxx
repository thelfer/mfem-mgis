#ifndef LIB_MFEM_MGIS_ISOTROPICTRIDIMENSIONALSTANDARDFINITESTRAINMECHANICSBEHAVIOURINTEGRATOR_HXX
#define LIB_MFEM_MGIS_ISOTROPICTRIDIMENSIONALSTANDARDFINITESTRAINMECHANICSBEHAVIOURINTEGRATOR_HXX
...
namespace mfem_mgis {
  ...
  /*!
   */
  struct MFEM_MGIS_EXPORT IsotropicTridimensionalStandardFiniteStrainMechanicsBehaviourIntegrator
 ...
 */
IsotropicTridimensionalStandardFiniteStrainMechanicsBehaviourIntegrator(const FiniteElementDiscretization &,
             const size_type,
...
rotateThermodynamicForces(mgis::span<const real>, const RotationMatrix&);
...
//! \brief destructor
~IsotropicTridimensionalStandardFiniteStrainMechanicsBehaviourIntegrator() override;
...
/*!
 * \return the integration rule for the given element and  * element transformation.
 * \param[in] e: element
 ...
 * \param[in] m: material attribute.
 */
static std::shared_ptr<const PartialQuadratureSpace> buildQuadratureSpace(const FiniteElementDiscretization &,
                     const size_type);
/*!
 ...
 * with the contribution of the consistent tangent operator of  * an integration point.
 *
...
void updateStiffnessMatrix(mfem::DenseMatrix &,
    ...
    };  // end of struct IsotropicTridimensionalStandardFiniteStrainMechanicsBehaviourIntegrator

}  // end of namespace mfem_mgis

#endif /* LIB_MFEM_MGIS_ISOTROPICTRIDIMENSIONALSTANDARDFINITESTRAINMECHANICSBEHAVIOURINTEGRATOR_HXX*/
