...
#ifndef LIB_MFEM_MGIS_TRIDIMENSIONALMICROMORPHICDAMAGEBEHAVIOURINTEGRATOR_HXX
#define LIB_MFEM_MGIS_TRIDIMENSIONALMICROMORPHICDAMAGEBEHAVIOURINTEGRATOR_HXX
...
namespace mfem_mgis {
   ...
   * assumed to be zero).
   */
  struct MFEM_MGIS_EXPORT TridimensionalMicromorphicDamageBehaviourIntegrator
    ...
    //! \brief destructor
    ~TridimensionalMicromorphicDamageBehaviourIntegrator() override;
...
#endif
  };  // end of struct TridimensionalMicromorphicDamageBehaviourIntegrator

}  // end of namespace mfem_mgis

#endif /* LIB_MFEM_MGIS_TRIDIMENSIONALMICROMORPHICDAMAGEBEHAVIOURINTEGRATOR_HXX \
        */
