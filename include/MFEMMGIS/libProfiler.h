...
#define LIB_MPI 0
#else
#define LIB_BARRIER MPI_Barrier(MPI_COMM_WORLD)
#define LIB_MPI 1
#endif
...
#define _PLATFORM_OS_WINDOWS    1
#define _PLATFORM_OS_LINUX      2
#define _PLATFORM_OS_MACOSX     3
...
#define _PLATFORM_COMPILER_MSVC  1
#define _PLATFORM_COMPILER_GCC   2

#if defined( _MSC_VER )
#   define _PLATFORM_COMPILER            _PLATFORM_COMPILER_MSVC
#   define _PLATFORM_COMPILER_VERSION    _MSC_VER
#   define IS_COMPILER_MSVC     1
#   define IS_COMPILER_GCC      0
#   pragma message("Platform Compiler is Microsoft Visual C++.")
#elif defined( __GNUC__ )
#   define _PLATFORM_COMPILER            _PLATFORM_COMPILER_GCC
#   define _PLATFORM_COMPILER_VERSION    (__GNUC__ * 10000 + __GNUC_MINOR__ * 100)
...
#define _PLATFORM_MEMORY_ADDRESS_SPACE_32BIT  1
#define _PLATFORM_MEMORY_ADDRESS_SPACE_64BIT  2

#if defined(__x86_64__) || defined(_M_X64) || defined(__powerpc64__)
#   define IS__PLATFORM_64BIT                1
#   define IS__PLATFORM_32BIT                0
#   define _PLATFORM_MEMORY_ADDRESS_SPACE    _PLATFORM_MEMORY_ADDRESS_SPACE_64BIT
#   pragma message("Using 64bit memory address space.")
#else
#   define IS__PLATFORM_64BIT                0
#   define IS__PLATFORM_32BIT                1
#   define _PLATFORM_MEMORY_ADDRESS_SPACE    _PLATFORM_MEMORY_ADDRESS_SPACE_32BIT
...
void Zprofiler_start( const char *profile_name )
{
    ...
    if ((*IterCallsByThreadMap).second.empty())
    {
        ...
        sprintf(GenProfilerData.szBunchCodeName, "%s%d%s%s", _NAME_SEPARATOR_,  static_cast<int> (ulThreadId), _THREADID_NAME_SEPARATOR_, profile_name);
...
void LogProfiler()
{
    ...
    for(IterTmpCallStack=tmpCallStack.begin(); IterTmpCallStack!=tmpCallStack.end(); ++IterTmpCallStack)
    {
        ...
        size		= static_cast<long>(tmpString-(*IterTmpCallStack).szBunchCodeName);
