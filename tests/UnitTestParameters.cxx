...
int main() {
  ...
  std::string string_value =
      "Merci à toi jeune aventurier de bien vouloir regarder des tests "
      "unitaires";
  ...
  std::vector<Parameter> param_vector = {param_real, param_size_type,
                                         param_string};
  ...
  //  std::string msg_constructor_1 = "Parameter&
  //  Parameter::operator=(std::string_view src)"; Parameter
  //  test_constructor_parameter_1(msg_constructor_1);
  std::string_view msg_constructor_2 =
  ...
  Parameters params_copy2(
      std::move(params));               // init a parameters with a parameters
  ...
  auto test_get_if_parameter_no_ok =
  ...
  for (auto it = params2.cbegin(); it != params2.cend(); it++) {
    ccount++;
  }
